...
public class AlertDialogFragment extends DialogFragment {
	 ...
	 * @param positiveButtonStringId
	 *            The resource id of the positive button
	 * @return
	 */
	 ...
	 * @param positiveButtonStringId
	 *            The resource id of the positive button
	 * @param negativeButtonStringId
	 *            The resource if of the negative button
	 * @return
	 */
	public static AlertDialogFragment newInstance(int titleId, int messageId,
	 ...
	 * @param negativeButtonStringId
	 *            The resource if of the negative button
	 * @param neutralButtonStringId
	 *            The resource if of the neutral button
	 * @return
	 */
	public static AlertDialogFragment newInstance(int titleId, int messageId,
			int positiveButtonStringId, int negativeButtonStringId,
	 ...
	 * 
	 * @param l
	 *            The listener that is called when the negative button is
	 *            clicked
	 * @return This FragmentAlertDialog object to allow for chaining of calls to
	 *         set methods.
	 */
	 ...
	 * 
	 * @param l
	 *            The listener that is called when the neutral button is clicked
	 * @return This FragmentAlertDialog object to allow for chaining of calls to
	 *         set methods.
	 */
	 ...
	 * {@link #setNeutralButtonClickListener(OnClickListener)}
	 * 
	 * @param b
	 * @return
	 */
	 ...
	 * {@link #setNegativeButtonClickListener(OnClickListener)}
	 * 
	 * @param b
	 * @return
	 */
	 ...
	 * sets the {@link #useStringTitle} so the {@link #onCreateDialog(Bundle)}
	 * can use the correct method of setting the title.
	 * 
	 * @param titleString
	 *            The String that will appear in the title.
	 */
	 ...
	 * sets the {@link #useStringMessage} so the {@link #onCreateDialog(Bundle)}
	 * can use the correct method of setting the message.
	 * 
	 * @param messageString
	 *            The String that will appear in the message.
	 */
